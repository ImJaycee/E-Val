                    ...
                    <tbody>
                        @foreach($instructors as $instructor)
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3 text-left font-semibold text-md text-gray-100 text-left">
                                    <a href="javascript:void(0);" class="bg-red-800 p-2 rounded" data-instructor-id="{{ $instructor->instructor_id }}" onclick="openModal('{{ $instructor->instructor_id }}')">
