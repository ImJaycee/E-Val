        ...
        <div class="overflow-y-auto" style="max-height: 450px">
            <table id="reportTable" class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-800">
                            <form action="{{ route('view.summary') }}" method="POST" target="_blank">
                                ...
                                <button class="px-4 py-2 bg-blue-500 text-white rounded">View Summary</button>
                            </form>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-800">2022-2023</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-800">2nd</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-800">
                            <form action="{{ route('view.summary') }}" method="POST" target="_blank">
                                @csrf
                                <input type="text" name="A_Y" id="A_Y" value="2022-2023" class="hidden">
                                <input type="text" name="semester" id="semester" value="1st" class="hidden">
                                <button class="px-4 py-2 bg-blue-500 text-white rounded">View Summary</button>
                            </form>
                        </td>
