...
<div id="sideNav" class="lg:block hidden bg-gray-700 w-64 h-screen fixed rounded-none border-none">
    ...
    <div class="p-4 space-y-4">
        ...
        <a href="{{route('instructor.evaluation')}}" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-200 group">
        ...
        <a href="{{route('instructor.comments')}}" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-200 group">
            <i class="fas fa-comment"></i>
            <span>Comments</span>
        </a>
        <a href="{{route('instructor.feedback')}}" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-200 group">
            <i class="fas fa-comment"></i>
            <span>Feedback</span>
        </a>
